...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /local/reps/CMSSW/UserCode/pablom/MuonAlignmentAlgorithms/test/runDTLocalMillepede.py,v $'),
...
process.source = cms.Source("PoolSource", 
    ...
    fileNames = cms.untracked.vstring("file:/tmp/pablom/72B4916F-5179-DE11-9049-001D09F25460.root")
)
